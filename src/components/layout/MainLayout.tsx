  ...
  return (
    <div className="min-h-screen bg-bg">
      ...
      <header className="sticky top-0 z-40 px-3 pt-2.5 pb-2 sm:px-4 sm:pt-3">
        <nav className="max-w-4xl mx-auto flex items-center justify-between bg-bg-surface border border-border rounded-xl px-3 py-2 sm:px-4 sm:py-2">
          {/* Logo */}
          ...
          <div className="flex items-center gap-1">
            {NAV_LINKS.map(({ to, label, icon: Icon }) => {
              ...
              return (
                ...
                >
                  <Icon className="w-8 h-4 sm:w-3.5 sm:h-3.5 flex-shrink-0" />
