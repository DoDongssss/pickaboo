        ...
        <>
          ...
          <div className="flex flex-col gap-3 mb-8">
            {live.map(m => {
              ...
              return (
                <div key={m.id}
                  className="card border-accent/30 bg-accent-soft/20 p-4">
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      ...
                      <p className="text-xs text-text-2">
                        Set {m.match_scores.length} · {m.match_players.length} players
                      </p>
                    </div>
                      ...
                      <tr key={m.id}
                        ...
                        <td className="px-4 py-3">
                          ...
                          <span className="text-[10px] px-1.5 py-0.5
                            bg-bg-surface2 text-text-3 rounded-full">
                            {m.type}
                          </span>
                        </td>
                        <td className="px-4 py-3 text-xs text-text-2">
                          {m.match_players.length} players
                        </td>
